...
- A version strip under the title says which build this server carries and how many machines in use are on another one; **Update all** brings every one of them forward and reconnects it in one tap.
